...
public class CurpGenerator {
    ...
    public static final String[] MESES = { "Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov",
            "Dec" };

    public static final String[] MESES_VALOR = { "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11",
            "12" };
    ...
    public static String generate(String primerApellido, String segundoApellido, String nombres, String sexo,
        ...
        String error = validarDatos(primerApellido, segundoApellido, nombres, sexo, fechaDeNacimiento,
                entidadDeNacimiento);
        if (error != null) {
